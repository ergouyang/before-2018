...
class xc():
    ...
    def pc(self):
        ...
        for name in names:
            ...
            allscore = []
            alltime = []
            for i in range(1,402,1):#从360助手网址分析可以发现 &start=  后面的数字是指每页返回评论数的开始编号（如&start=50  是指从第50条评论获取）
                ...
                url='http://m.app.so.com/message/index?page='+str(i)+'&requestType=ajax&name='+str(name)
                ...
                time2 = []headers = {
                    ...
                    'Cookie':'__guid=140996974.2229985817631850200.1499358219631.323; count=2',
                    'Host':'m.app.so.com',
                    'Referer':'http://m.app.so.com/detail/index?from=qing&id=841215',
